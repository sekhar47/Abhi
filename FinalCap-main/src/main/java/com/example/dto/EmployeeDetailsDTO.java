...
public class EmployeeDetailsDTO {
    ...
    @OneToOne(cascade = CascadeType.ALL, mappedBy = "employeeDetailsDTO")
	...
	public EmployeeDetailsDTO(String domain, String subdomain, String skillname, String proficiency, String certificationname, Integer trainingdays) {
	    this.domain = domain;
	    this.subdomain = subdomain;
	    this.skillname = skillname;
	    this.proficiency = proficiency;
